                ...
                <div class="col-12 hero-text-image">
                    <div class="row">
                        <div class="col-lg-12 text-center mb-5">
                            <h1 data-aos="fade-right">Pets</h1>
                            <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Select the pet you want to adopt from the available list below!</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3" id="myUl">
                    <div class="card shadow p-3 mb-5 bg-white">
                        <div class="card-body">
                            ...
                            <form method="POST" action="aforms.php">
                                <input type="hidden" value="<?php echo $row['petname']; ?>" name="petname">
                                <div class="text-center">

                                    <button type="submit" class="btn btn-dark btn-sm"> Adopt Me</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row site-section pt-0">
                        <div class="col-md-4 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <l><a href="donations.php">Donations</a></l>
