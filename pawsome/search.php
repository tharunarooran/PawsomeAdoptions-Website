                ...
                <div class="col-12 hero-text-image">
                    <div class="row">
                        <div class="col-lg-12 text-center mb-5">
                            <h1 data-aos="fade-right">Find your pets!</h1>
                            <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Search for the type of breed you want.</p>
                        </div>
                    </div>
                </div>
            </div>
...
$stmt = $conn->prepare("SELECT COUNT(*) AS numrows FROM pets WHERE breed LIKE :keyword");
...
if ($row['numrows'] < 1) {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM pets WHERE breed LIKE :keyword");
        $stmt->execute(['keyword' => '%' . $_POST['keyword'] . '%']);
                        ...
                        <div class="card shadow p-3 mb-5 bg-white">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="" class="btn btn-dark btn-sm"> Adopt Me</a>
                                </div>
                            </div>
                        </div>
                    </div>
